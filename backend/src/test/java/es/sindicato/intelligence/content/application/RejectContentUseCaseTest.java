...
class RejectContentUseCaseTest {
    ...
    @Test
    void recordsAuditWhenContentIsRejected() {
        ...
        RejectContentUseCase useCase = new RejectContentUseCase(repository, audit);
        ...
        assertEquals(ContentStatus.REJECTED, result.getStatus());
        verify(audit).record(eq("CONTENT_REJECTED"), eq("CONTENT"), eq(10L), eq(null), any());
    }
